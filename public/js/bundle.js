...
},{"./lib/axios":"../../node_modules/axios/lib/axios.js"}],"allert.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.allert = void 0;
 ...
 */
var allert = function allert(text, options) {
  var defaultOptions = {
    type: null,
    // type is  CSS class `alert-type`
    align: 'top-right',
    duration: 2000,
  ...
  options = _typeof(options) === 'object' ? options : defaultOptions; // set options

  for (var propertyName in defaultOptions) {
    if (defaultOptions.hasOwnProperty(propertyName)) {
      if (options[propertyName] === undefined || options[propertyName] === null || options[propertyName] === '') {
  ...
  if (options.type) {
    typeMarkup = "allert-".concat(options.type);
  } // Generate the HTML


  var element = document.createElement('div');
  element.setAttribute('class', "allert allert-".concat(options.align, " ").concat(typeMarkup));
  element.setAttribute('title', text);
  element.innerHTML = text;
  container.appendChild(element);

  var close = function close(elem) {
    elem.classList.add('allert-fadeout'); // after the fadeout remove the element from DOM
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            (0, _allert.allert)(_context.t0.response.data.message, {
              type: 'danger',
              align: 'top-left'
            });
...
exports.login = login;
},{"axios":"../../node_modules/axios/index.js","./allert":"allert.js"}],"controllersButton.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.pageNext = exports.pagePrevious = exports.saveDocument = exports.deleteDocument = exports.cancelEdit = exports.editDocument = void 0;
...
var createdButton = function createdButton(className, id) {
...
var editDocument = function editDocument(elem) {
  //save to localstore. If user to press cancel
  var numberRow = elem.classList[1];
  var elemRow = document.querySelector(".row-content.".concat(numberRow));
  var elemEditable = elemRow.querySelectorAll('.edit');
  localStorage.setItem(elemRow.firstElementChild.textContent, elemRow.innerHTML);

  for (var i = 0; i < elemEditable.length; i++) {
    elemEditable[i].contentEditable = true;
  } //change button


  elem.nextSibling.replaceWith(createdButton("cancel_button ".concat(numberRow), 'cancel', '❎'));
  elem.replaceWith(createdButton("save_button ".concat(numberRow), 'save', '✔'));
};

exports.editDocument = editDocument;

var cancelEdit = function cancelEdit(elem) {
  var numberRow = elem.classList[1];
  var elemRow = document.querySelector(".row-content.".concat(numberRow));
  ...
  elem.previousSibling.replaceWith(createdButton("edit_button ".concat(numberRow), 'edit'));
  elem.replaceWith(createdButton("delete_button ".concat(numberRow), 'delete'));
};
...
var deleteDocument = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(elem) {
    var numberRow, elemRow, res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            numberRow = elem.classList[1];
            elemRow = document.querySelector(".row-content.".concat(numberRow));
            _context.next = 4;
            return (0, _axios.default)({
              method: 'DELETE',
              url: '/',
              data: {
                _id: elemRow.firstChild.innerText
              }
            });
...
var saveDocument = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(elem) {
    var numberRow, elemRow, elemEditable, data, i, res;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            numberRow = elem.classList[1];
            elemRow = document.querySelector(".row-content.".concat(numberRow));
            elemEditable = elemRow.querySelectorAll('.edit');
            data = {};

            for (i = 0; i < elemEditable.length; i++) {
          ...
          case 8:
            res = _context2.sent;
            //change buttonD
            elem.nextSibling.replaceWith(createdButton("delete_button ".concat(numberRow), 'delete'));
            elem.replaceWith(createdButton("edit_button ".concat(numberRow), 'edit'));
  ...
  return function saveDocument(_x2) {
...
var pagePrevious = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
    var numberPage, lastPage;
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            numberPage = location.pathname.match(/\d+$/)[0];
            lastPage = document.querySelector('#pagelast').getAttribute('href').match(/\d+$/)[0];

            if (numberPage !== '1') {
              numberPage--;
              location.assign("/page/".concat(numberPage));
            } else {
              (0, _allert.allert)('Вы на первой странице', {
                type: 'danger',
                align: 'top-left'
              });
            }
  ...
  return function pagePrevious() {
    return _ref3.apply(this, arguments);
  };
}();

exports.pagePrevious = pagePrevious;

var pageNext = /*#__PURE__*/function () {
        ...
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            if (numberPage !== lastPage) {
              ...
              (0, _allert.allert)('Вы на последней странице', {
                type: 'danger',
                align: 'top-left'
              });
            }
  ...
  return function pageNext() {
    return _ref4.apply(this, arguments);
  };
}();

exports.pageNext = pageNext;
},{"axios":"../../node_modules/axios/index.js","./allert":"allert.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var _controllersButton = require("./controllersButton");
...
if (username && password) {
  document.querySelector('.auth').addEventListener('submit', function (e) {
    e.preventDefault();
    (0, _login.login)(username.value, password.value);
  });
}

var panelPage = document.querySelector('.row-content'); // delegate events for buttons
...
if (panelPage) {
  document.querySelector('#main').onclick = function () {
    ...
    switch (target.id) {
      case 'edit':
        (0, _controllersButton.editDocument)(target);
        break;

      case 'delete':
        (0, _controllersButton.deleteDocument)(target);
        break;

      case 'save':
        (0, _controllersButton.saveDocument)(target);
        break;

      case 'cancel':
        (0, _controllersButton.cancelEdit)(target);
        break;

      case 'pagenext':
        (0, _controllersButton.pageNext)(target);
        break;

      case 'pageprevious':
        (0, _controllersButton.pagePrevious)(target);
        break;
